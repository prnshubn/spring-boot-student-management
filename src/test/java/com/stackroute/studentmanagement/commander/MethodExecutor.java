package com.stackroute.studentmanagement.commander;
...
public class MethodExecutor {
    private static Logger logger = LoggerFactory.getLogger(com.stackroute.studentmanagement.MethodExecutor.class);
